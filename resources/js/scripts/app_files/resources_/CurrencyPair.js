class CurrencyPair {
	...
	requestUpdateLevels(value){
		setTimeout(function(){
			return fetch("http://127.0.0.1:8000/api/currency-pair/request-update-levels/"+this.name+"/"+value, {mode: 'no-cors'});	
		}, 7000)
	}
	 ...
	 */
	evaluateLastAlertMartingala(current_open)
    {
        ...
        if(last_candle){
	        ...
	        if(launch_alert){
	        	if(
	        		...
	        		if(attemps >= config_trading.attemps_for_only_direction && attemps_direction != 0){
	        			last_candle.alert_martingala = attemps_direction > 0?-1:1;
			            ...
			            attemps_direction += last_candle.alert_martingala;
			        }
			        ...
			        startEntryMartingala(last_candle.id_martingala, last_candle.alert_martingala);
			        ...
			        last_direction = last_candle.alert_martingala;
		        }else{
