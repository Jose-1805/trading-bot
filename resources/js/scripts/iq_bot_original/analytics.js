(function() {
    ...
    var aa = function(a, b, c) {
        ...
        r.history && r.history.replaceState && (R.test(b) || R.test(c)) && (a = A(a, "path"),
        b = d(b, "?"),
        c = d(c, "#"),
    ...
    function Z(a, b, c) {
        b.href && (a = W(a, b.href, void 0 === c ? !1 : c),
        q.test(a) && (b.href = a))
    }
    function Y(a, b) {
        if (b && b.action) {
...
(function() {
    ...
    var bd = function(a) {
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j79", "sr=1"],
        b && a.push("_f=" + b),
      ...
      , td = function(a, b) {
        ...
        c || e || g || ca))
            ...
            a.get(bc) || ye(a.get(Kd))) {
                ...
                g ? (J(82),
                a.data.set(ce, g),
                d.gclsrc && a.data.set(ie, d.gclsrc)) : ca && (d = ca.split(".")) && 2 === d.length && (J(37),
                a.data.set(ce, d[0]),
                a.data.set(fe, d[1])),
                c)
                    b: if (d = c.indexOf("."),
            ...
            if (c) {
                ...
                if (("https:" == a || a == d || ("http:" != a ? 0 : "http:" == d)) && B(ca)) {
                    if (ca = ca.url)
                        ...
                        f.test(ca) && M.write("<script" + e + ' src="' + ca + '">\x3c/script>')) : (e = M.createElement("script"),
